...
rclone copy --log-level INFO --ignore-existing --log-file ~/nando-dol-amroth.log /mnt/Anime b2:helms-deep/Media/Anime
...
rclone copy --log-level INFO --ignore-existing --log-file ~/nando-dol-amroth.log /mnt/Movies b2:helms-deep/Media/Movies
rclone copy --log-level INFO --ignore-existing --log-file ~/nando-dol-amroth.log /mnt/Music b2:helms-deep/Media/Music
rclone copy --log-level INFO --ignore-existing --log-file ~/nando-dol-amroth.log /mnt/TV_Shows b2:helms-deep/Media/TV_Shows
